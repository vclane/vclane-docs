...
VC-LANE uses two Firebase database services: **Firestore** for persistent structured data and **Realtime Database (RTDB)** for real-time device telemetry and status.
...
|---|---|---|---|
| *(device fields)* | *various* | Device payload | Device-specific data (vehicleCount, trafficDensity, cpuUsage, etc.) |
